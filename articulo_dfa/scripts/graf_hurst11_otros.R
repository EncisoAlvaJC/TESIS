...
Hurst.select.NMOR = Hurst.NMOR[!is.na(Hurst.NMOR$Usar),]
Hurst.select.todo = Hurst.todo[!is.na(Hurst.todo$Usar),]

###############################################################################
# Neuropsi vs MMSE
cor.test(Hurst.select.MOR$Neuropsi,Hurst.select.MOR$MMSE,
         method='spearman')

cor.test(Hurst.select.MOR$Neuropsi,Hurst.select.MOR$MMSE,
         method='pearson')

ggplot(Hurst.select.MOR,aes(x=Neuropsi,y=MMSE,shape=Grupo,
                              add='reg.line')) +
  theme_classic2() +
...
###############################################################################
# Neuropsi vs Edad
cor.test(Hurst.select.MOR$Edad,Hurst.select.MOR$Neuropsi,
         method='spearman')

cor.test(Hurst.select.MOR$Edad,Hurst.select.MOR$Neuropsi,
         method='pearson')

ggplot(Hurst.select.MOR,aes(x=Edad,y=Neuropsi,shape=Grupo,
                              add='reg.line')) +
  theme_classic2() +
  geom_smooth(method=lm,
...
for(ch in 1:n.canales){
  ...
  Hurst.tmp = Hurst.select.NMOR[grep(ch.actual,Hurst.select.NMOR$Canal_var),]
...
ggplot(Hurst.select.NMOR,aes(x=Neuropsi,y=Hurst,
...
for(ch in 1:n.canales){
  ch.actual = kanales$Etiqueta[ch]
  Hurst.tmp = Hurst.select.MOR[grep(ch.actual,Hurst.select.MOR$Canal_var),]
...
ggplot(Hurst.select.MOR,aes(x=Neuropsi,y=Hurst,
                              shape=Grupo,color=Grupo))+
  ylab('Hurst Exponent') +
  labs(shape=NULL,color=NULL) +
  facet_wrap(~Canal_var,ncol=6) +
...
ggplot(Hurst.select.MOR,aes(x=Edad,y=Hurst,
                              shape=Grupo,color=Grupo))+
  ylab('Hurst Exponent') +
  labs(shape=NULL,color=NULL) +
  facet_wrap(~Canal_var,ncol=6) +
...
ggplot(Hurst.select.NMOR,aes(x=Edad,y=Hurst,
                               shape=Grupo,color=Grupo))+
  ylab('Hurst Exponent') +
  labs(shape=NULL,color=NULL) +
  facet_wrap(~Canal_var,ncol=6) +
...
for(ch in 1:n.canales){
  ch.actual = kanales$Etiqueta[ch]
  #Hurst.tmp = Hurst.MOR.promedio[grep(ch.actual,Hurst.MOR.promedio$Canal_var),]
  Hurst.tmp = Hurst.select.MOR[grep(ch.actual,
                                    Hurst.select.MOR$Canal_var),]
...
for(ch in 1:n.canales){
  ch.actual = kanales$Etiqueta[ch]
  #Hurst.tmp = Hurst.NMOR.promedio[grep(ch.actual,Hurst.NMOR.promedio$Canal_var),]
  Hurst.tmp = Hurst.select.NMOR[grep(ch.actual,
                                     Hurst.select.NMOR$Canal_var),]
...
for(ch in 1:n.canales){
  ...
  Hurst.tmp = Hurst.select.todo[grep(ch.actual,
                                    Hurst.select.todo$Canal_var),]
  ...
  k = t.test(a,b,na.action(na.omit),paired = F)
...
comparaciones.todo     = matrix(0,nrow=n.canales,ncol=5)
comparaciones.todo[,1] = kanales$Etiqueta
colnames(comparaciones.todo) = c('Canal','p','dF','t','m')
for(ch in 1:n.canales){
  ch.actual = kanales$Etiqueta[ch]
  #Hurst.tmp = Hurst.todo.promedio[grep(ch.actual,
  #                                     Hurst.todo.promedio$Canal_var),]
  ...
  comparaciones.todo[ch,'p']  = k$p.value
  comparaciones.todo[ch,'dF'] = k$parameter
  comparaciones.todo[ch,'t']  = k$statistic
  comparaciones.todo[ch,'m'] = k$estimate[1]
}
