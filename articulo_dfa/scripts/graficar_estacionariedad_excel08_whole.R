...
ggplot(RES.MOR,aes(x=Neuropsi,y=Proporcion*100,
  ...
  geom_point()
ggsave(filename='/neuropsi_stat_whole_mor.png',path=dir_graf,
...
ggplot(RES.NMOR,aes(x=Neuropsi,y=Proporcion*100,
  ...
  theme(legend.position=c(1,.05),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  geom_point()
ggsave(filename='/neuropsi_stat_whole_nmor.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)
...
ggplot(RES.MOR,aes(x=Edad,y=Proporcion*100,
  ...
  theme(legend.position=c(1,.05),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  geom_point()
ggsave(filename='/edad_stat_whole_mor.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)
...
ggplot(RES.NMOR,aes(x=Edad,y=Proporcion*100,
  ...
  theme(legend.position=c(1,.05),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  geom_point()
ggsave(filename='/edad_stat_whole_nmor.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)
...
ggplot(promedios.MOR,aes(x=Canal_var,y=Proporcion,fill=Grupo)) +
  ...
  theme(legend.position=c(1,1),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  rotate_x_text(angle = 45)
ggsave(filename='/comparacion_stat_whole_mor.png',path=dir_graf,
...
ggplot(promedios.NMOR,aes(x=Canal_var,y=Proporcion,fill=Grupo)) +
  ...
  theme(legend.position=c(1,1),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  rotate_x_text(angle = 45)
ggsave(filename='/comparacion_stat_whole_nmor.png',path=dir_graf,
       device='png',units='cm',width=8,height=4,dpi=400,scale=2)
...
ggplot(promedios.todo,aes(x=Canal_var,y=Proporcion,fill=Grupo)) +
  ...
  facet_grid(Etapa~.) +
  rotate_x_text(angle = 45)
ggsave(filename='/comparacion_stat_whole_uno_CTRL_PMCI.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)
...
ggplot(promedios.todo,aes(x=Canal_var,y=Proporcion,fill=Etapa)) +
  ...
  stat_compare_means(data=RES.todo,inherit.aes=F,
                     ...
                     label='p.signif',method='t.test',
                     hide.ns=T,label.y=.6,paired=T)+
  theme(legend.position=c(1,1),legend.direction = 'horizontal',
        legend.justification=c(1,0))+
  facet_grid(Grupo~.) +
  rotate_x_text(angle = 45)
ggsave(filename='/comparacion_stat_whole_uno_REM_NREM.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)

# significativos
promedios.CTRL.signif = promedios.todo[grep(c('CTRL'),
                                            promedios.todo$Grupo),]
patch = is.element(promedios.CTRL.signif$Canal_var,c('P4','P3','PZ','ROG','EMG'))
promedios.CTRL.signif = promedios.CTRL.signif[patch,]
RES.CTRL.signif = RES.todo[grep(c('CTRL'),RES.todo$Grupo),]
patch = is.element(RES.CTRL.signif$Canal_var,c('P4','P3','PZ','ROG','EMG'))
RES.CTRL.signif = RES.CTRL.signif[patch,]

promedios.PMCI.signif = promedios.todo[grep(c('PMCI'),
                                            promedios.todo$Grupo),]
patch = is.element(promedios.PMCI.signif$Canal_var,c('P4','P3','EMG'))
promedios.PMCI.signif = promedios.PMCI.signif[patch,]
RES.PMCI.signif = RES.todo[grep(c('PMCI'),RES.todo$Grupo),]
patch = is.element(RES.PMCI.signif$Canal_var,c('P4','P3','EMG'))
RES.PMCI.signif = RES.PMCI.signif[patch,]

ggplot(promedios.CTRL.signif,aes(x=Canal_var,y=Proporcion,fill=Etapa)) +
  labs(title='B') +
  theme_classic2() +
  labs(fill=NULL) +
  xlab(NULL) + ylab('Stationary epochs [%]') +
  ...
  #scale_fill_manual(values = c('#2b83ba','#d7191c'))+
  scale_fill_manual(values = c('#bebada','#fb8072'))+
  stat_compare_means(data=RES.CTRL.signif,inherit.aes=F,
                     mapping=aes(x=Canal_var,y=Proporcion,fill=Etapa),
                     label='p.signif',method='t.test',
                     hide.ns=T,label.y=.6,paired=T)+
  theme(legend.position=c(1,1),legend.direction = 'horizontal',
...
ggsave(filename='/comparacion_stat_whole_signif_1.png',path=dir_graf,
       device='png',units='cm',width=6,height=3,dpi=400,scale=2)

ggplot(promedios.PMCI.signif,aes(x=Canal_var,y=Proporcion,fill=Etapa)) +
  #labs(title='B') +
  theme_classic2() +
  labs(fill=NULL) +
  xlab(NULL) + ylab('Stationary epochs [%]') +
  ...
  #scale_fill_manual(values = c('#2b83ba','#d7191c'))+
  scale_fill_manual(values = c('#bebada','#fb8072'))+
  stat_compare_means(data=RES.PMCI.signif,inherit.aes=F,
                     mapping=aes(x=Canal_var,y=Proporcion,fill=Etapa),
                     label='p.signif',method='t.test',
                     hide.ns=T,label.y=.6,paired=T)+
  theme(legend.position=c(1,1),legend.direction = 'horizontal',
...
ggsave(filename='/comparacion_stat_whole_signif_2.png',path=dir_graf,
       device='png',units='cm',width=4,height=3,dpi=400,scale=2)
