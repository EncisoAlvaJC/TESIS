...
ggplot(promedios.todo,aes(x=Etapa,y=Hurst,color=Grupo))+
  ...
  scale_y_continuous(expand=c(0,0),breaks = c(1.1,1.2,1.3,1.4,1.5)) +
...
ggsave(filename='/cabeza_ANOVA_Hurst_inter.png',path=dir_graf,
       device='png',units='cm',width=7,height=14,dpi=400,scale=1.2)
ggsave(filename='/cabeza_ANOVA_Hurst_inter.eps',path=dir_graf,
       device='eps',units='cm',width=7,height=14,dpi=400,scale=1.2)
