...
ggsave(filename='/comparacion_stat_CTRL_PMCI.png',path=dir_graf,
...
A = ggplot(promedios.todo,aes(x=Canal_var,y=Proporcion,fill=Etapa)) +
  ...
  rotate_x_text(angle = 45)
ggarrange(A,labels=NULL)
ggsave(filename='/comparacion_stat_MOR_NMOR.png',path=dir_graf,
       device='png',units='cm',width=8,height=6,dpi=400,scale=2)
...
# 
# ggsave(filename='/comparacion_stat_signif_2.png',path=dir_graf,
