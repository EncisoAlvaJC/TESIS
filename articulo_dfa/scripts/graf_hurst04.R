...
for(ch in 1:n.canales){
  ...
  correlaciones[,'R_Spear'] = k$estimate
  correlaciones[,'p']       = k$p.value
  correlaciones[,'S']       = k$statistic
}
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropis (total)',
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropsi (total)',
           col.names=TRUE,row.names=TRUE,append=TRUE)
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropis (promedio)',
           col.names=TRUE,row.names=TRUE,append=TRUE)
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropsi (promedio)',
           col.names=TRUE,row.names=TRUE,append=TRUE)
...
write.xlsx(guardar,file=paste0(dir_graf,archivo.excel),
           sheetName='CTL_PDC inter',
           col.names=TRUE,row.names=TRUE,append=TRUE)

###############################################################################
# correlaciones
correlaciones     = matrix(0,nrow=n.canales,ncol=2)
correlaciones[,1] = kanales$Etiqueta
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropis (total) _ inter',
           col.names=TRUE,row.names=TRUE,append=TRUE)
...
write.xlsx(correlaciones,file=paste0(dir_graf,archivo.excel),
           sheetName='Hurst_Neuropsi (total) _ inter',
           col.names=TRUE,row.names=TRUE,append=TRUE)
