...
r_dir = paste0('C:/Users/Erika/Desktop/Julio161213/scripts170620/mini')
...
# parche rapido: tomare la primer epoca del primer MOR
epo_0 = (epoca  )*dur_epoca
epo_f = (epoca+1)*dur_epoca
...
for(ch in 1:22){
  ...
  setwd(r_dir)
  write.table(mini,
              paste0(nom_arch,'_',canal,'_',toString(epoca),'.txt'),
