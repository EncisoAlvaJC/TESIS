...
esperanza de vida como en la calidad de la misma, se ha observado [] un incremento en la presencia 
de enfermedades no-transmisibles asociadas con la edad, de entre las cuales destacaremos la 
demencia.
En particular, se cuenta con estudios estad\'isticos [] que sugieren una relaci\'on entre los 
...
maracadores de misma para su uso cl\'inico.
% \cite{Amer13,Miyata13,Potvin12}

El objeto de estudio del presente trabajo consiste en registros de actividad cerebral y muscular
durante el sue\~no (polisomnograf\'ia, PSG). La modelaci\'on matem\'atica de estos registros los 
entiende como como procesos estoc\'asticos a tiempo continuo cuyas propiedades son, por naturaleza,
no-estacionarias, no-lineales y sin-equilibrio. La propiedad de no-estacionariedad es de particular
relevancia, por ejemplo, en el an\'alisis de fractalidad y en la obtenci\'on dle espectro de
potencias de estas se\~nales; sin embargo, esta propiedad rara vez se verifica.
De hecho se ha sugerido [] que en casos at\'ipicos, como el del DC, la no-estacionariedad podr\'ia
no ser cierta. En este trabajo se investiga la posibilidad de que los registros de PSG en adultos
...
Se analizaron los registros de PSG correspondientes a 9 aultos mayores previamente diagn\'osticados
con o sin DC a trav\'es de una bater\'ia de pruebas neuropsicol\'ogicas. Se prest\'o especial
...
ah\'i su acr\'onimo).
Se encontr\'o que solamente en el grupo control (sin DC) existen diferencias significativas en el
porcentaje proporcional de estacionariedad en las regiones frontales y posteriores.
...
Por \'ultimo destacamos que en los adultos mayores sin DC es posible reconocer a simple vista
patrones muy definidos de etapas de estacionariedad, seguidas por una etapa de no-estacionariedad
seguidos por una etapa de sue\~no MOR.
