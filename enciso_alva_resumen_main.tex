...
cognitivo (DC) durante la vejez \cite{Amer13,Miyata13,Potvin12}
%; una duraci\'on menor del sue\~no 
...
Dentro de la modelaci\'on matem\'atica, usualmente se supone que las se\~nales electrofisiol\'ogicas
son no-estacionarias, no-lineales y sin-equilibrio por naturaleza, aunque estas propiedades no
suelen ser investigadas formalmente;
se ha sugerido que en casos at\'ipicos (en particular, afeccciones en el sistema nervioso),
esto puede no ser cierto \cite{McEwen75,Cohen77,Sugimoto78,Kawabata73}. 
En este trabajo se investiga la posibilidad de que los registros de 
actividad cerebral durante el sue\~no (polisomnograma, PSG)
%elecetroencefalograma (EEG) 
en personas con DC exhibe una estructura m\'as simple, en el sentido de
reducirse a series d\'ebilmente estacionarias;
...
Se utiliza la prueba para detectar estacionariedad d\'ebil propuesta por Priestley y 
Subba Rao \cite{Priestley69}, basada en la estimaci\'on local de espectros de potencias
en procesos estoc\'asticos.
Se trabaja especialmente en la etapa de sue\~no denominada
MOR (Movimientos oculares r\'apidos), que se cartacteriza por exhibir aton\'ia
muscular, actividad cerebral de baja amplitud y frecuencias mixtas, y MOR's.

Se estudiaron los registros de PSG para 
9 adultos mayores, quienes previamente fueron sometidos a una bater\'ia de pruebas 
neuropsicol\'ogicas. %y en conseciencia fueron clasificados en dos grupos: DC
%[edad: $66.3 \pm 2.8$, educaci\'on: $8.5 \pm 2.5$] 
%y Control.
%[edad: $68.2 \pm 7.2$, educaci\'on: 
%$9.2 \pm 2.7$].
Se encontraron diferencias significativas, en el grupo control, para la presencia proporcional de 
estacionariedad d\'ebil, 
%en \'epocas de 30 segundos, 
medida durante el sue\~no MOR y no-MOR.
%estas diferencias fueron claras en el grupo control. 
%en las regiones frontales y posteriores,
%pero estuvieron ausentes en el grupo conDC.
Estos resultados sugieren que, durante el DC, cambia la din\'amica del PSG al 
