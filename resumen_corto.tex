...
\bottomrule
\end{tabular}
\caption{Total de \'epocas clasificadas como PE en sue\~no NMOR, desglozado por canal. 
...
\bottomrule
\end{tabular}
\caption{Total de \'epocas clasificadas como PE en todo el registro, desglozado por canal. 
...
desglozados por canal. Se incluyen medias y desviaciones est\'andar para los grupos Control 
...
desglozado por canal. Se incluyen medias y desviaciones est\'andar para los grupos Control y PDC.}
\label{gpos_nmor}
\end{SidewaysTable}
...
fases), desglozado por canal. Se incluyen medias y desviaciones est\'andar para los grupos 
Control y PDC.}
\label{gpos_total}
\end{SidewaysTable}
