...
As\'i pues, y dadas las consideraciones anteriores, conviente
...
\end{equation*}
La sucesi\'on $\left( A_n \right)$ ser\'a referida como \textit{serie de Fourier}.
\end{defn}
...
Conviene, adem\'as, definir una \textbf{funci\'on de espectro integrado}
