...
En este contexto vale la pena mencionar que este concepto de energ\'ia, como aporte conjunto
...
terminolog\'ia e interpretaci\'on de energ\'ia; de modo que en este trabajo no s\'olo se contempla
...
en \ref{energia} usando \ref{parseval_serie}, mientras que un \textit{especxtro de potencia 
...
la SDF normalizada/no-normalizada es la transformada de Fourier (en alg\'un sentido) de la 
funci\'on de autocorrelaci\'on/autocovarianza;
intuitivamente esto quiere decir que un estimador muy natural para la SDF se puede construir 
...
Para hablar propiamente de la estimaci\'on de la SDF de un proceso, primero conviene 
