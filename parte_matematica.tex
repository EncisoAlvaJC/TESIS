...
El enfoque que se aborda es construir una sucesi\'on de funciones peri\'odicas que convergen a cada
...
Claramente, para todo $T$ se tiene que $x_T \in L^2$, y entonces es posible definir
\begin{equation}
