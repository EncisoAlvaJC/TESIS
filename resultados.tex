...
{./graficos170409/Comparacion_gpos_MOR.pdf} 
}\\
\subfloat[Comparaci\'on entre \'epocas no-MOR (fases W y N)]{
\includegraphics[width=0.95\linewidth]
{./graficos170409/Comparacion_gpos_NMOR.pdf} 
}\\
...
\includegraphics[width=0.95\linewidth]
{./graficos170409/comp_etapas_gpos_NORMALMOR_vs_TOTAL.pdf} 
}\\
\subfloat[Comparaci\'on para el grupo PDC]{
\includegraphics[width=0.95\linewidth]
{./graficos170409/comp_etapas_gpos_PDCMOR_vs_TOTAL.pdf} 
}\\
\subfloat[Comparaci\'on de los p-valores para aceptar diferencias]{
\includegraphics[width=0.95\linewidth]
{./graficos170409/Comparacion_pvals_gpos_MOR_vs_TOTAL.pdf} 
}\\
...
{./complementario170409/ehemplo.png}
