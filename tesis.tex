...
%asdasd%
%\nomenclature{AABFM}{Actividad de amplitud relativamente baja ($<10 \mu$A), visualmente desorganizada.
...
Función definida principalmente para facilitar la referencia de productos ortogonales.
\begin{equation*}
