...
\input{./texto/intro_v5.tex}

\input{./texto/preliminares_v2.tex}

\input{./texto/espectro_v4.tex}

\input{./texto/espectro_evolutivo_v2.tex}
...
\input{./texto/pruebas_neuro_v1.tex}
...
\bibliography{referencias_fisiologia,referencias_estacionariedad,referencias_otros,referencias_mixto}%{}
%referencias_fisiologia,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyNTA5NzQ3OF19
-->