...
multipsr <- function(ch,nombre,w_dir,c_dir,r_dir,
  ...
  setwd(r_dir)
  write.csv(pv.t  , paste0('EST_',nombre,'_',canal,'_T.csv'  ))
  write.csv(pv.ir , paste0('EST_',nombre,'_',canal,'_IR.csv' ))
  write.csv(pv.tir, paste0('EST_',nombre,'_',canal,'_TIR.csv'))
}
