...
En esta secci\'on se exponen los conceptos que son usados durante el presente trabajo en un estilo
de \textit{glosario comentado} con el objetivo de ser concreto y \'util en este contexto.
Por comodidad esta secci\'on se ha dividido en dos grandes subsecciones, fisiolog\'ia y 
matem\'aticas, cada cual con una estructura y compromisos metodol\'ogicos marcadamente diferentes.
En la primera subsecci\'on se mencionan fen\'omenos el deterioro cognitivo en adultos mayores en
al nivel de poblaci\'on, aunque s\'olo como motivaci\'on pues el cuerpo principal de este trabajo es
sobre el sistema nervioso a nivel de sistema, sobre el cual se mencionan los conceptos pertinentes;
adicionalmente se habla un poco sobre c\'omo fue el registro de estos fen\'omenos.
En cuanto a la segunda subsecci\'on, se centra en las herramientas usadas
para analizar los registros obtenidos, as\'i como algunos temas relacionados que facilitan el texto.
Por \'ultimo, cabe advertir que estas dos secciones son diferentes no s\'olo en temas sino que
tambi\'en en un sentido epist\'emico: mientras en la primera subsecci\'on se mencionan afirmaciones
basadas en datos experimentales y acompa\~nados de las citas pertinentes, en la segunda subsecci\'on
se mencionan afirmaciones que son demostradas formalmente en los ap\'endices de este texto o en
o, para casos muy puntuales, en otros que son citados.
