...
%Aún son incipientes los estudios sobre conductas modificables asociadas a la aparición
%de tales enfermedades \cite{PlanAlzheimer04}.
...
%El diagnóstico clínico y las investigaciones básicas dependen en gran medida de la capacidad de 
%registrar y analizar las señales; sin embargo, los métodos tradicionales para este objetivo no han 
%seguido el ritmo de los avances tecnológicos más recientes, que permiten el almacenar y procesar 
%conjuntos masivos datos relativos a señales de origen biológico.
