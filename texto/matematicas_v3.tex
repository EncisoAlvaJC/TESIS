...
%1-u^{2}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_parzen1.pdf}
%\\
%Parzen (2) &
%$\displaystyle 
%\frac{1}{1+\abso{u}}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_parzen2.pdf}
%\\
%\rowcolor{gris}
%Parzen (3) &
%$\displaystyle 
%\frac{1}{1+u^{2}}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_parzen3.pdf}
%\\
\rowcolor{gris}
Bartlett-Priestley &
$\displaystyle 
...
%$\displaystyle 
%\begin{cases}
%1-6 u^{2} + 6 \abso{u}^{3} &, \abso{u}\leq \nicefrac{1}{2}\\
%2\left( 1-\abso{u} \right)^{3} &, \text{otro caso}
%\end{cases}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_parzen4.pdf}
%\\
%\rowcolor{gris}
%Tukey &
%$\displaystyle 
%1 -2a +2a \COS{\pi u}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_tukey.pdf}
%\\
Cosenoidal &
$\displaystyle 
\COS{\pi u}
...
%$
%}
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_neave.pdf}
%\\
%\rowcolor{gris}
%Cuadrática &
%$\displaystyle 
...
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_cuadratica.pdf}
%\\
%Bartlett-Priestley &
%$\displaystyle 
%\frac{3}{(\pi u)^{2}} \left[ \frac{\SEN{\pi u}}{\pi u} - \COS{\pi u} \right]
...
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_papoulis.pdf}
%\\
%Cosenoidal &
%$\displaystyle 
%\COS{\pi u}
...
%\end{cases}
%$
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_trapezoidal.pdf}
%\\
%Normal &
%$\displaystyle 
%\exp \left( - \nicefrac{u^{2}}{2 \sigma^{2}}  \right)
%$
%%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_normal.pdf}
%& \includegraphics[width=3cm,height=2cm]{./img_ventanas/ventana_.pdf}
%\\
%\bottomrule
%\end{tabular}
%}
