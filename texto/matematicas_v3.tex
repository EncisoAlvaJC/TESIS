...
con el tiempo. 
%
Tal condición es difícil de detectar a partir de series de tiempo, debido a lo cual se suelen 
...
Sobre el efecto del muestreo, consíderese un proceso a tiempo continuo y débilmente estacionario, 
