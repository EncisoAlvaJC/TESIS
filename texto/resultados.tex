...
registros de PSG organizados en \'epocas de 10 segundos de duraci\'on, como se muestra en la figura
\ref{epocas_diferentes} (comparar con figura \ref{diagrama_psr}). Se realizaron todos los an\'alisis 
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{./img_diagramas/epocas_diferentes.pdf}
\caption{Esquema de c\'omo se han tomado diferentes tama\~nos de \'epoca para estudiar los mismos
datos.}
