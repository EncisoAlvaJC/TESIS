...
Los hemisferios cerebrales se componen de capas de las cuales la más externa, conocida como
...
\midrule
Vigilia & W  & \textbf{Ritmo alfa} en $>50$\% de la época    & No & Alto \\
        &    & en la región occipital                &    &      \\
NMOR 1  & N1 & Cambio de alfa por AABFM, atenuación & Lentos & Variable,     \\
        &    & del ritmo dominante. Ondas agudas   &    & $<$W     \\
NMOR 2  & N2 & Husos de sueño y complejos K en la    & No & Variable     \\
        &    & primera mitad de la época. AABFM &    & $<$W, $>$R    \\
NMOR 3  & N3 & \textbf{Ondas lentas} (0.5--2 Hz, $> 75 \mu$V)& No & Variable, \\
        &    & para $>20$\% de la época. Husos de sueño       && $<$N2, $\approx$R     \\
...
Por espacio se abvrevia AABFM = actividad de amplitud baja y frecuencias mixtas }
\end{table}
