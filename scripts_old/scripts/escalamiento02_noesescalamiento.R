...
result_dir  = 'C:/Users/EQUIPO 1/Desktop/julio/estacionariedad_promedio/'
...
for(dur_epoca in duraciones){
  ...
  for(sujeto in 1:12){
    ...
    source('multipsr_curso01_personal02.R' ) 
    #source('multipsr_curso01_personal03.R' )
