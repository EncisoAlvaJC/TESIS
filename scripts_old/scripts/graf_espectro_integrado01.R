...
#                      v.directorio[sujeto])
dir_res_mid  = 'C:/Users/EQUIPO 1/Desktop/julio/espectro_integrado/'
#dir_graf     = getwd()#paste0(getwd(),'/espetro_integrado_g')
dir_graf     = 'C:/Users/EQUIPO 1/Desktop/julio/espectro_int_g/'
#fr_muestreo  = 512
...
#dev.off()
colorgram(z=t(RES),outlier='white',bty='n',axes=F,
...
axis(1,at=(0:n_epocas)[skip],labels=F,las=2,tick=T)
axis(4,at=c(1,n_epocas-1)-.5,    labels=F,las=2,tick=T)
axis(1,at=c(0,n_epocas),labels=F,tick=T)
